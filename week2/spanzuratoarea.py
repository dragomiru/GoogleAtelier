...
while numar_incercari <= 2:
    ...
    if litera_incercata in cuvant_initial:
        ...
        if litera_incercata not in set_litere_incercari:
            numar_incercari += 1
        set_litere_incercari.add(litera_incercata)
        ...
        print(f"Mai ai: {3 - numar_incercari} incercari. Ai incercat deja aceasta litera. "
              f"Literele incercate sunt: {','.join(set_litere_incercari)}")
