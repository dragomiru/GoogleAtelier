...
#         if x % 5 == 0:
#             lista_2.append(x)
# lista_2 = [x for x in range(50) if x % 2 == 0 if x % 5 == 0] # <-- Good version.
# lista_2 = [x if x % 5 == 0 else 0 for x in range(50) if x % 2 == 0] # <-- Bad version.
# print(lista_2)

# dictionar = {}
# for num in range(1, 11):
#     dictionar[num] = num*num
dictionar = {num: num*num if num % 2 == 0 else 0 for num in range(1, 11) if num % 2 == 0} # <-- Before forloop, that's for value.
                                                                                          # After forloop, that's for key.
print(dictionar)
